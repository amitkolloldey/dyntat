...
if ( BBOptions::get('bb-bsearch-sidebar-status') == 'full' ){ 

	$blogStatus_class = 'col-md-12 bb-blog-full'; 

}elseif ( BBOptions::get('bb-bsearch-sidebar-status') == 'ls' ) {

	$blogStatus_class = 'col-md-9 bb-blog-left-sidebar'; 
	$blogStatus_Sidebar_class = 'bb-left-sidebar';

}elseif ( BBOptions::get('bb-bsearch-sidebar-status') == 'rs' ) {
...
$blogStyleWarp_class = '';
$blogLayout_class 	 = '';
if ( BBOptions::get('bb-blog-search-layout') == 'gt2' ){ 
	...
	<div class="container">
		<div class="row">
			...
			*********************************************************************
			--> 
			<?php
				if ( BBOptions::get('bb-bsearch-sidebar-status') == 'ls' ) {
			...
			<div class="<?php echo $blogStatus_class; ?> bb-no-padding">
				<div class="blog-wrapper <?php echo $blogStyleWarp_class; ?>"> 
					<div class="blog-posts <?php echo $blogLayout_class; ?>">
						...
						<?php  if ( BBOptions::get('bb-blog-search-layout') == 'gt2' ){ echo '<div class="bb-grid-item">'; } ?>
							<div class="single-post">  
								<!-- Post Thumb -->
								<?php 
									if ( (BBOptions::get('bb-blog-search-thumb-status') == '1') && has_post_thumbnail(get_the_ID()) && ! post_password_required() ) {
								...
								<div class="post-cont">
									...
									<?php
										if (BBOptions::get('bb-blog-search-meta-status') == 1 ){
						...
						<?php  if ( BBOptions::get('bb-blog-search-layout') == 'gt2' ){ echo '</div>'; } ?>
						<?php endwhile; endif;  ?>
					</div> 
			...
			*********************************************************************
			--> 
			<?php
				if ( BBOptions::get('bb-bsearch-sidebar-status') == 'rs' ) {
					echo '<div class="col-md-3 bb-no-padding '.$blogStatus_Sidebar_class.'">';
				 	get_sidebar();
					echo '</div>';
				} 
