...
if ( BBOptions::get('bb-blog-sidebar-status') == 'full' ){ 
	$blogStatus_class = 'col-md-12 bb-blog-full'; 
}elseif ( BBOptions::get('bb-blog-sidebar-status') == 'ls' ) {
	$blogStatus_class = 'col-md-9 bb-blog-left-sidebar'; 
	$blogStatus_Sidebar_class = 'bb-left-sidebar';
}elseif ( BBOptions::get('bb-blog-sidebar-status') == 'rs' ) {
	...
	<div class="container">
		<div class="row">
			<?php
				...
				*********************************************************************
				*/ 
				if ( BBOptions::get('bb-blog-sidebar-status') == 'ls' ) {
			...
			*********************************************************************
			...
			<?php
				...
				*********************************************************************
				*/ 
				if ( BBOptions::get('bb-blog-sidebar-status') == 'rs' ) {
					echo '<div class="col-md-3 bb-no-padding '.$blogStatus_Sidebar_class.'">';
				 	get_sidebar();
					echo '</div>';
				} 
