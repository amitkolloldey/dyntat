...
@section('title') Create Client Says @stop
...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Create Client Says</li>
      </ol>
    </section> 
    <!-- Main content -->
    <section class="content">
		<div class="row">
			...
			//print_r($errors); 
				...
				<div class="box"> 
				{!! Form::open(['route' => 'clientsay.create', 'class' => 'test-create-form']) !!} 
					...
					<div class="box-body">  
						...
						<div class="col-md-7">
							...
							<div class="form-group">
								<label>Client Say message:</label>
