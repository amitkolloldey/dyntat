    ...
    <section class="content">
		<div class="row">
			...
			//print_r($errors); 
				...
				<div class="box"> 
				{!! Form::open(['route' => 'partner.update', 'class' => 'test-create-form']) !!} 
									...
									<div id="multipleupload" class="multipleupload" action="{{ route('upload.partner.thumb') }}">
										<div class="dropzone"  >
											<div class="dz-message" >
												<img id="post-thumb-prev" src="{{ adminUrl($partner->thumb) }}" alt="" />
												<h3>Drop images here or click to upload.</h3>
											</div> 
										</div> 
									</div>
									<input id="post-thumb-input" type="hidden" class="form-control" name="thumb" value="{{$partner->thumb}}" >
								</div>
								<!-- /.input group -->
							</div>
							<!-- /.form group --> 
