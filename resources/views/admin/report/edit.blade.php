...
@section('title') Update Report @stop
<!-- Select2 -->
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    {!! Form::open(['route' => 'report.update', 'class' => 'test-create-form']) !!}
                                ...
                                <div class="form-group order-id-warp" data-selurl="{{route('get.Oder.Detiels')}}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control order-id" name="order_id" style="width: 100%;">
                                            <option value="{{ $Reports->order_id }}">{{ $Reports->order->invoice_no }}</option>
                                        </select>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                    ...
                    success: function (response) {
                        if (response.status == true) {
                            ...
                            for (var i = 0; i < response.data.length; i++) {
                                ...
                                pageHtml += "<div class='page-img'><div class='form-group'><label> Report For " + response.data[i]['name'] + "</label><div class='input-group'><div class='pageimage'></div><input type='text' class='form-control book-img-input' name='testReports[" + response.data[i]['id'] + "]' value='' style='pointer-events: none;' required ></div></div></div></div>";
