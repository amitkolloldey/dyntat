...
@section('title') Create Publication @stop
...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Create Publication</li>
      </ol>
    </section> 
    <!-- Main content -->
    <section class="content">
		<div class="row">
			...
			//print_r($errors); 
				...
				<div class="box"> 
				{!! Form::open(['route' => 'publication.create', 'class' => 'test-create-form']) !!} 
									...
									<div class="book-page">
										...
										<div class="page-name">
											<div class="form-group">
												...
												<div class="input-group"> 
													<input type="text" class="form-control" name="pageName[]" value="" > 
												</div> 
												<!-- /.input group -->
											</div>
										</div>
										<div class="page-img">
											<div class="form-group">
												...
												<div class="input-group"> 
													...
													<input type="hidden" class="form-control book-img-input" name="pageImage[]" value="" >
												</div>
												<!-- /.input group -->
											</div>
										</div>
										...
										<div class="page-img-prev">
											<img class="book-img-prev" src="" alt="">
										</div>
									</div>
								</div>
