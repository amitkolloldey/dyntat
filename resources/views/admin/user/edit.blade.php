    ...
    <section class="content">
		<div class="row">
			...
			//print_r($errors); 
				...
				<div class="box"> 
				{!! Form::open(['route' => 'user.update', 'class' => 'user-create-form']) !!} 
					...
					<div class="col-md-5">  
						<div class="form-group user-thumb-group">
							...
							<div class="input-group post-thumb-field"> 
									...
									<div class="dropzone"  >
										<div class="dz-message" >
											@if($userImg = json_decode($user->picture))
												<img id="post-thumb-prev" src="{{ adminUrl($userImg->thumb) }}" alt="" />
											@else
								...
								<input id="post-thumb-input" type="hidden" class="form-control" name="picture" value="{{$user->picture}}" >
							</div>
							<!-- /.input group -->
						</div>
						<!-- /.form group --> 
