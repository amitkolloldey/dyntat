    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    {!! Form::open(['route' => 'test.update', 'class' => 'test-create-form']) !!}
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="sl_no"
                                                   value="{{ $test->sl_no }}">
                                        </div>
                                            ...
                                            <div class="cats-list-checkbox">
                                                @foreach($cats as $cat)
                                                    <label>
                                                        ...
                                                        <!-- @-if( in_array($cat->name, $test->categories->toarray() ) )-->
                                                        @if( in_array($cat->id, $test->getCategoriesIdOnly($test) ) )
                                    ...
                                    <div class="form-group hidden">
                                        ...
                                        <div class="input-group post-thumb-field">
                                            <div id="multipleupload" class="multipleupload"
                                                 action="{{ route('upload.test.thumb') }}">
                                                <div class="dropzone">
                                                    <div class="dz-message">
                                                        @if( $test->picture != "" && $testImg = json_decode($test->picture) )
                                                            <img id="post-thumb-prev"
                                                                 src="{{ adminUrl($testImg->thumb) }}" alt=""/>
                                                        @endif
                                                        <h3>Drop images here or click to upload.</h3>
                                                    </div>
                                                </div>
                                            </div>
                                            <input id="post-thumb-input" type="hidden" class="form-control"
                                                   name="picture" value="{{ $test->picture }}">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
