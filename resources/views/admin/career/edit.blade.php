...
@section('title') Edit Job Post @stop
    ...
    <section class="content">
		<div class="row">
			...
			//print_r($errors); 
				...
				<div class="box"> 
				{!! Form::open(['route' => 'career.update', 'class' => 'test-create-form']) !!} 
						...
						<div class="row"> 
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="date" class="form-control" name="endDate" value="{{$Career->endDate}}" >
								</div> 
								<!-- /.input group -->
							</div>
							<!-- /.form group -->  							
							...
							<div class="form-group">
								...
								<div class="input-group"> 
									<textarea rows="10" class="test-content" name="content">{{$Career->content}}</textarea>
								</div> 
								<!-- /.input group -->
							</div>
							<!-- /.form group -->   
