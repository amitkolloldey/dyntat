...
@section('title') Create Offer @stop
    ...
    <section class="content">
		<div class="row">
			...
			//print_r($errors); 
				...
				<div class="box"> 
				{!! Form::open(['route' => 'offer.create', 'class' => 'test-create-form']) !!} 
					...
					<div class="box-body">  
						...
						<div class="col-md-8">
							...
							<div class="form-group">
								...
								<div class="input-group"> 
									<textarea rows="10" class="form-control test-content" name="content"></textarea>
								</div>  
							</div>
							<!-- /.form group -->  
						</div>
