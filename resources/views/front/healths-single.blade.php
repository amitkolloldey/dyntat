...
@section('pagetitle2')
    <a href="{{route('health.all.front')}}">Health Screening</a><span
            class="glyphicon glyphicon-menu-right"></span>Health Screen Details
@stop
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    ...
                    @section('pagetitle') Health Screen Details @stop
                    @section('metas')
                            ...
                            <div class="single-service">
                                ...
                                <div class="health-heading">
                                    <div class="health fature-image">
                                        ...
                                        {{--src="{{ adminUrl($HealthScreen->thumb) }}"--}}
                                        {{--data-origin="{{ adminUrl($HealthScreen->thumb) }}">--}}
                                        {{--</div>--}}
...
@endsection
@section('scripts')
    <script src="{{ asset('public/assets/js/jquery.imgzoom.js') }}"></script>
    <script>
