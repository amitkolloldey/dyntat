                    ...
                    <div class="main-content">
                        <div class="product-table-warp">
                            <table class="table table-bordered cart_summary">
                                <thead>
                                <tr>
                                    <th class="test_thumb">Test Image</th>
                                    <th class="test_name">Test Name</th>
                                    <th class="test_shortName">Test Short Name</th>
                                    <th class="test_quantity">Test Quentity</th>
                                    <th class="test_price">Price</th>
                                </tr>
                                </thead>
                                <tbody>
                ...
                <div class="payment-option-wrapper">
                    ...
                    <div class="ssl" id="ssl_div">
                        <button class="accordion" id="btn_ssl">
                            <input id="rad_ssl" type="radio" style="margin-right: 20px;">Pay Online
                        </button>
                        <div class="panel" id="view_ssl">
                            <div id="test-payment">
                                ...
                                <form id="sslcommerz_form" class="hidden"
                                      name="payment_gw"
                                      action="https://sandbox.sslcommerz.com/gwprocess/v3/process.php"
                                      method="post">
                                    <input type="hidden" name="version" value="3.00"/>
                                    <input id='total_amount' name="total_amount" readonly="" value="{{$payableAmount}}"
                                           type="hidden" id="total_value">
                                    <input name="tran_id" readonly="" value="{{Cart::tranId()}}"
                                           type="hidden">
                                    <input name="store_id" readonly="" value="test_dyntatbd" type="hidden">
                                    <input name="currency" readonly="" value="BDT" type="hidden">
                                    <input name="cus_name" readonly="" value="{{$userInfo['parsonName']}}"
                                           type="hidden">
                                    <input name="cus_email" readonly="" value="{{$userInfo['ParsonEmail']}}"
                                           type="hidden">
                                    <input name="cus_phone" readonly=""
                                           value="{{$userInfo['ParsonNumber']}}" type="hidden">
                                    <input name="cus_add1" readonly=""
                                           value="{{$userInfo['ParsonAddress']}}" type="hidden">

                                    <input name="success_url" readonly="" value="{{route('pay.val.front')}}"
                                           type="hidden">
                                    <input name="fail_url" readonly="" value="{{route('pay.faild.front')}}"
                                           type="hidden">
                                    <input name="cancel_url" readonly=""
                                           value="{{route('pay.cancel.front')}}"
                                           type="hidden">
                                    @foreach($bank_discount as $discount)
                                        @if($discount->id == $id_discount)
                                            <input class='card' name='multi_card_name' readonly=''
                                                   value='{{$discount->field_name}}' type='hidden'>
                                        @endif
                                    @endforeach
                                </form>
                            </div>
                    ...
                    <div class="cod" id="cod_div">
                        <button class="accordion" id="btn_cod">
                            <input id="rad_cod" type="radio" style="margin-right: 20px;">Cash On Delivery
                        </button>
