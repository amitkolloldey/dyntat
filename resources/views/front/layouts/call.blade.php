{{--<div class="par_call" id="myBtn">--}}
    {{--TODO::PARVEZ POPUP BUTTON--}}
    {{--<img src="{{asset('public/admin-assets/dist/img/call/phone.png')}}" alt="" style="width:35px">--}}
{{--</div>--}}
            ...
            <ul>
                <li class="numbers">
                    ...
                    <div class="content">
                        ...
                        <span class="title">+8809666737373</span>
